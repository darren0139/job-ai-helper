...
QUICK_TEST_MODULES = (
    ...
    "tests.test_phase8_phase9c_aggregation_parity",
    "tests.test_phase9b_v8_final_seed_contract",
    ...
    "tests.test_phase9e_original_source_identity",
    "tests.test_application_blueprint_manager",
    "tests.test_phase9e_streamlit_acceptance",
    "tests.test_phase9e1_workflow_ui",
    "tests.test_phase9e1_ui_ordering",
    ...
    "tests.test_phase9e1_previous_scope_top_summary_clarity_v1",
    "tests.test_phase9e1_previous_scope_guidance_clarity_v1",
    "tests.test_phase9e1_saved_docx_none_guard_v1",
